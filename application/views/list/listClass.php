	...
	<div class="mainbox">
		...
		<div class="maintablebox">
			...
			<div class="maintable xmaintable" >
            	...
            	<table width="100%" border="0" cellspacing="0" cellpadding="0" id=<?php echo 'tab_con_'.$key1?> <?php if($key1!='C1'){echo 'style="display:none"';}?> >
					<thead>
						<tr>
							<td>登降園状況</td>
                            <td>苗字</td>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo URL::site('child/health').URL::query(array('ID'=>$val['ID'],'from'=>$controller.'/'.$action,'show'=>$key1));?>"><input type="button" value="作成" /></a></td>
                            	<td><a href="<?php echo URL::site('child/contact').URL::query(array('ID'=>$val['ID'],'from'=>$controller.'/'.$action,'show'=>$key1));?>"><input type="button" value="出カ" /></a></td>
