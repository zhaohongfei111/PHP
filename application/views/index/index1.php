		...
		<div class="innavbox">
			<div class="innavlist left">
				<ul>
					...
					-->
					<li><a href="javascript:void(0)"><img src="<?php echo $media;?>images/hnav011.jpg"/></a></li>
			...
			<div class="xnotice xnotice01 right">
				...
				<div class="intxt01">
					...
					<p>[受付時間]　<?php if(empty($guardianCon)){echo '_________';}else{ echo empty($guardianCon['0']['Acceptance_Data'])?'_________':$guardianCon['0']['Acceptance_Data'];}?>間に合わない場合は下記へご連絡ねがいます。</p>
					<h3>082-221-5493</h3>
