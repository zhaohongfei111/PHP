...
<title><?php echo $_GET['goodsName'];?>-用品イメージの添付</title>
 <!--引入CSS-->
...
<body>
<div>用品イメージの添付（<?php echo $_GET['goodsName'];?>）</div>
...
<script>
//上传文件使用
var fileParameter = '<?php echo 'http://'.$_SERVER['SERVER_NAME'].URL::site('administration/saveGoodsImages').URL::query();?>';
</script>
