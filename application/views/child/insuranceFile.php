...
<ul class="filelists">
	...
	?>
	<li>
        <p class="imgWrap"><img src="<?php echo $media.'uploadfile/'.$key;?>"></p>
...
<script>
//上传文件使用
var fileParameter = '<?php echo 'http://'.$_SERVER['SERVER_NAME'].URL::site('child/saveImages').URL::query();?>';
</script>
...
$(function(){
	...
	$('.filelists .cancel').bind('click',function(event){
		 $.ajax({
			type: "POST",
			url: "<?php echo URL::site('child/delInsuranceFile');?>",
			cache: false,
			dataType: 'json',
