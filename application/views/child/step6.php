...
<body>
	...
	?>
<form id="formMain" action="<?php echo URL::site('child/step6_insert').URL::query();?>" method="post" enctype="multipart/form-data">
	...
	<div class="mianbox">
		<div class="content">
			<div class="datebox">
				...
				<div class="databut">
					<input type="button" value="前 頁に 戻 る" onClick="location.href='<?php echo URL::site('child/step5').URL::query();?>'" />
