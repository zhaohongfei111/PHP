				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody id=<?php echo 'tab_con_'.$key1?> <?php if($key1!='C1'){echo 'style="display:none"';}else {echo 'style="display:table-row-group"';}?>>
                     <?php 
                      ...
                      ?>
                        <tr>
                            <td class="tt01"><a href="<?php echo URL::site('listHistory/editHistoryDetail').URL::query(array('ID'=>$val['ID'],'historyFrom'=>'listHistory/listClass'));?>"><input type="button" value="確認" /></a></td>
