					...
					<thead>
						...
						<tbody>	
						 <?php 
                          ...
                          ?>
                            <tr>
                                <td class="tt01"><a href="<?php echo URL::site('listHistory/editHistoryDetail').URL::query(array('ID'=>$val['ID'],'historyFrom'=>'listHistory/listRearch'));?>"><input type="button" value="確認" /></a></td>
